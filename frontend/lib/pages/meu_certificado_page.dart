...
class MeuCertificadoPage extends StatefulWidget {
  const MeuCertificadoPage({super.key});

  @override
  State<MeuCertificadoPage> createState() => _MeuCertificadoPageState();
}

class _MeuCertificadoPageState extends State<MeuCertificadoPage> {
  ...
  Future<void> _carregarCertificado() async {
    ...
    try {
      final cert = await ApiService.meuCertificado();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Meu Certificado'),
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          onPressed: _carregarCertificado,
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            children: [
                              ...
                              const SizedBox(height: 8),
                              ...(_certificado!['palestras'] as List)
                                  .map((p) {
                                return Padding(
